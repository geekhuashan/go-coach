...
新增 GoGameGuru 题库保留原作者署名与 CC BY-NC-SA 4.0 数据许可；原始 420 题逐题回放校验，417 题激活，基础变式精简后合计 457 道可选题。来源、数量与未激活原因见 [第三方数据说明](docs/THIRD_PARTY_DATA.md)。
...
- **练习题**：落子后自动反馈结果、原因与棋盘标记，并保存作答。四类基础知识点，8 个基础局面按难度保留 32 个旋转／镜像版本（一级每类 3 个，二级每类 5 个）；另有 8 个原创多手吃子局面，难度 3–5。原三道题与精简前的变式继续兼容，已有作答记录和成绩保留。

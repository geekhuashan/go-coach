...
class ProfilesHTTPTest(unittest.TestCase):
    ...
    def test_profile_isolation_reload_and_stale_revision(self):
        ...
        self.assertEqual(child['feedback'],[]);self.assertEqual(child['board'][4][2],0)
        ...
        self.assertEqual(restored['board'][4][2],1)
    ...
    def test_inspect_assistance_and_new_profile(self):
        self.action('inspect',x=2,y=3);s=self.action('play',x=2,y=4)
